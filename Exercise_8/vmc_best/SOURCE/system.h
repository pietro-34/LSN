...
private:
  ...
  bool _measure_prob_density;                               // ADD BY ME ; Flag for measuring prob density in VMC 
  ...
  int _index_prob_density;                                  // ADD BY ME. Indices for accessing prob density in VMC
  ...
  int _n_bins_dp;        // Number of bins for density probability distribution
  ...
  double _bin_size_dp;   // Size of bins for density probability distribuiton
  double _x_min=-3.0; 
  double _x_max=3.0;          //_x_max__x_min=withd interval 
