...
public:
  ...
  //Method to generate a random number with a exponential distribution; add by me
  double Exponential(double lambda=1);
  //Method to generate a random number with a Cauchy-Lorentz distribution; add by me
  double CauchyLorentz(double mu=0, double Gamma=1);
  //method to initialize random generator; add by me
