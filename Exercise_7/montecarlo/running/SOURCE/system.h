...
private:
  ...
  bool _measure_instant_temp;                               // Flag (add by me) for measuring instant temperature
  bool _measure_instant_magnet;                             // Flag (add by me) for measuring instant magnetization;
  bool _measure_instant_pot;                                // Flag (add by me) for measuring instant potential;
...
public: // Function declarations
  ...
  void write_starting_velocities_distribution(); // Write starting velocities distribution
  ...
  void spin(); //aggiunto d ame per stampare gli spin a schermo, per vedere se inizializza tutti gli spin a 1;
};
